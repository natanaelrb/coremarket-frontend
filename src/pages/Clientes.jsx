...
import {
  MOCK_KPIS,
  MOCK_ALERTAS,
} from "../features/clientes/data/mockClientes.js";
  ...
  return (
    <div className="mx-auto w-full -mt-4 -ml-2 max-w-[1400px] space-y-5">
            ...
            ? [
                {
                  ...
                  saldo: modals.clienteAlvo.emAberto,
                },
              ]
            : []
        }
      ...
      <ImportarClientesModal
        open={modals.modal === "importar"}
        onClose={modals.fechar}
        onImportado={() => {}}
      />

      <SegmentacaoModal
        open={modals.modal === "segmentar"}
        onClose={modals.fechar}
      />
    </div>
  );
