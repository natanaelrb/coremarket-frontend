...
import { Users, Wallet, ShoppingCart, Package } from "lucide-react";
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm">
          ...
          <div className="space-y-4">
            <div className="flex justify-between">
              ...
              <span className="font-semibold text-gray-800">R$ 50</span>
            </div>

            <div className="flex justify-between">
              <span className="text-gray-600">Maria</span>

              <span className="font-semibold text-gray-800">R$ 120</span>
            </div>

            <div className="flex justify-between">
              <span className="text-gray-600">Pedro</span>

              <span className="font-semibold text-gray-800">R$ 80</span>
            </div>
          </div>
        </div>
      </div>
